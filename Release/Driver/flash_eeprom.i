...
# 5 "../Driver/flash_eeprom.h" 2
# 13 "../Driver/flash_eeprom.h"
typedef enum
{
    EEPROM_OK = 0,
    EEPROM_ERR_PARAM,
...
{
    {((((0x00000000UL) + ((0x0400UL) * 12UL)) + ((0x0400UL) * 98UL)) + ((0x0400UL) * 98UL)), ((0x0400UL) * 1UL) * 42},
    {(((((0x00000000UL) + ((0x0400UL) * 12UL)) + ((0x0400UL) * 98UL)) + ((0x0400UL) * 98UL)) + ((0x0400UL) * 1UL) * 42), ((0x0400UL) * 1UL) * 2},
    {((((((0x00000000UL) + ((0x0400UL) * 12UL)) + ((0x0400UL) * 98UL)) + ((0x0400UL) * 98UL)) + ((0x0400UL) * 1UL) * 42) + ((0x0400UL) * 1UL) * 2), ((0x0400UL) * 1UL) * 2},
    {(((((((0x00000000UL) + ((0x0400UL) * 12UL)) + ((0x0400UL) * 98UL)) + ((0x0400UL) * 98UL)) + ((0x0400UL) * 1UL) * 42) + ((0x0400UL) * 1UL) * 2) + ((0x0400UL) * 1UL) * 2), ((0x0400UL) * 1UL) * 2},
};
...
static void ee_scan_page(eeprom_sec_t sec, uint32_t page_addr)
{
    ...
    while ((addr_cur + sizeof(record_head)) <= (page_addr + ((0x0400UL) * 1UL)))
    {
        ...
        {
            sec_info->write_addr = page_addr + ((0x0400UL) * 1UL);
            sec_info->next_record_seq = (uint16_t)(max_seq + 1);
            return;
        }
        ...
        if ((record_size > (((0x0400UL) * 1UL) - 8)) ||
            ((addr_cur + record_size) > (page_addr + ((0x0400UL) * 1UL))))
        {
            sec_info->write_addr = page_addr + ((0x0400UL) * 1UL);
            sec_info->next_record_seq = (uint16_t)(max_seq + 1);
            return;
...
static uint8_t ee_init_section(eeprom_sec_t sec)
{
    ...
    sec_info->page_count = sec_info->size / ((0x0400UL) * 1UL);
    ...
    for (page_index = sec_info->page_count; page_index > 0; page_index--)
    {
        ...
        page_addr = sec_info->start_addr + ((page_index - 1) * ((0x0400UL) * 1UL));
...
uint8_t ee_save(eeprom_sec_t sec, const void *data, uint16_t len)
{
    ...
    if (((uint32_t)sizeof(eeprom_record_head_t) + (((uint32_t)(len) + 7) & ~7)) > (((0x0400UL) * 1UL) - 8))
    {
        return EEPROM_ERR_PARAM;
    }

    if ((sec_info->write_addr + ((uint32_t)sizeof(eeprom_record_head_t) + (((uint32_t)(len) + 7) & ~7))) > (sec_info->active_page_addr + ((0x0400UL) * 1UL)))
    {
        for (page_index = ((sec_info->active_page_addr - sec_info->start_addr) / ((0x0400UL) * 1UL)) + 1;
             ...
             page_index++)
        {
            ...
            page_addr = sec_info->start_addr + (page_index * ((0x0400UL) * 1UL));
            flash_read_buf(page_addr, (uint8_t *)&page_flg, sizeof(page_flg));
...
uint8_t ee_load(eeprom_sec_t sec, void *data, uint16_t len)
{
    ...
    for (page_index = 0; page_index < sec_info->page_count; page_index++)
    {
        ...
        while ((addr + sizeof(record_head)) <= (page_addr + ((0x0400UL) * 1UL)))
        {
            ...
            if ((record_head.record_flg != 0x55AA33CC) ||
                (record_head.len == 0) ||
                (((uint32_t)sizeof(eeprom_record_head_t) + (((uint32_t)(record_head.len) + 7) & ~7)) > (((0x0400UL) * 1UL) - 8)) ||
                ((addr + ((uint32_t)sizeof(eeprom_record_head_t) + (((uint32_t)(record_head.len) + 7) & ~7))) > (page_addr + ((0x0400UL) * 1UL))))
            {
                break;
            }
