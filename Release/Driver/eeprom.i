...
# 74 "E:\\KF_Workspace\\Project_WorkSpace\\KF32F330_EVAL\\BSP/bsp_flash.h"
...
const uint32_t sec_table[4][2] =
{
    {((uint32_t)((uint32_t)((uint32_t)((uint32_t)0x00000000U) + ((uint32_t)((uint32_t)0x0400U) * 8)) + ((uint32_t)((uint32_t)0x0400U) * 100)) + ((uint32_t)((uint32_t)0x0400U) * 100)), ((uint32_t)((uint32_t)0x0400U) * 1) * 42},
    {(((uint32_t)((uint32_t)((uint32_t)((uint32_t)0x00000000U) + ((uint32_t)((uint32_t)0x0400U) * 8)) + ((uint32_t)((uint32_t)0x0400U) * 100)) + ((uint32_t)((uint32_t)0x0400U) * 100)) + ((uint32_t)((uint32_t)0x0400U) * 1) * 42), ((uint32_t)((uint32_t)0x0400U) * 1) * 2},
    {((((uint32_t)((uint32_t)((uint32_t)((uint32_t)0x00000000U) + ((uint32_t)((uint32_t)0x0400U) * 8)) + ((uint32_t)((uint32_t)0x0400U) * 100)) + ((uint32_t)((uint32_t)0x0400U) * 100)) + ((uint32_t)((uint32_t)0x0400U) * 1) * 42) + ((uint32_t)((uint32_t)0x0400U) * 1) * 2), ((uint32_t)((uint32_t)0x0400U) * 1) * 2},
    {(((((uint32_t)((uint32_t)((uint32_t)((uint32_t)0x00000000U) + ((uint32_t)((uint32_t)0x0400U) * 8)) + ((uint32_t)((uint32_t)0x0400U) * 100)) + ((uint32_t)((uint32_t)0x0400U) * 100)) + ((uint32_t)((uint32_t)0x0400U) * 1) * 42) + ((uint32_t)((uint32_t)0x0400U) * 1) * 2) + ((uint32_t)((uint32_t)0x0400U) * 1) * 2), ((uint32_t)((uint32_t)0x0400U) * 1) * 2},
};
...
typedef struct
{
    ...
    uint32_t write_addr;
    uint16_t next_record_seq;
} eeprom_sec_info_t;

static eeprom_sec_info_t ee_sec_info[4];
...
static void ee_scan_page(eeprom_sec_t sec, uint32_t page_addr)
{
    ...
    uint16_t max_seq = 0;
    uint32_t addr_cur = page_addr + 8;
    eeprom_record_head_t record_head;

    sec_info = &ee_sec_info[sec];

    while ((addr_cur + sizeof(record_head)) <= (page_addr + ((uint32_t)((uint32_t)0x0400U) * 1)))
    {
        flash_read_buf(addr_cur, (uint8_t *)&record_head, sizeof(record_head));

        if (record_head.record_flg == 0xFFFFFFFF)
        {
        ...
        if (record_head.record_flg != 0x55AA33CC)
        {
            sec_info->write_addr = page_addr + ((uint32_t)((uint32_t)0x0400U) * 1);
            sec_info->next_record_seq = (uint16_t)(max_seq + 1);
            return;
        }
        ...
        uint32_t record_size = ((uint32_t)sizeof(eeprom_record_head_t) + (((uint32_t)(record_head.len) + 7) & ~7));
        if ((record_size > (((uint32_t)((uint32_t)0x0400U) * 1) - 8)) ||
            ((addr_cur + record_size) > (page_addr + ((uint32_t)((uint32_t)0x0400U) * 1))))
        {
            sec_info->write_addr = page_addr + ((uint32_t)((uint32_t)0x0400U) * 1);
            sec_info->next_record_seq = (uint16_t)(max_seq + 1);
            return;
...
static uint8_t ee_init_section(eeprom_sec_t sec)
{
    ...
    sec_info = &ee_sec_info[sec];
    sec_info->start_addr = sec_table[sec][0];
    sec_info->size = sec_table[sec][1];
    sec_info->page_count = sec_info->size / ((uint32_t)((uint32_t)0x0400U) * 1);
    ...
    for (page_index = sec_info->page_count; page_index > 0; page_index--)
    {
        ...
        page_addr = sec_info->start_addr + ((page_index - 1) * ((uint32_t)((uint32_t)0x0400U) * 1));
        flash_read_buf(page_addr, (uint8_t *)&page_flg, sizeof(page_flg));

        if (page_flg == 0xAA55BBCC)
        {
    ...
    sec_info->write_addr = sec_info->start_addr + 8;
    sec_info->next_record_seq = 1;
...
static uint8_t ee_write_record(eeprom_sec_info_t *sec_info, const void *data, uint16_t len)
{
    ...
    record_head.record_flg = 0x55AA33CC;
    ...
    sec_info->write_addr += ((uint32_t)sizeof(eeprom_record_head_t) + (((uint32_t)(len) + 7) & ~7));
...
uint8_t ee_save(eeprom_sec_t sec, const void *data, uint16_t len)
{
    ...
    if (((uint32_t)sizeof(eeprom_record_head_t) + (((uint32_t)(len) + 7) & ~7)) > (((uint32_t)((uint32_t)0x0400U) * 1) - 8))
    {
        return EEPROM_ERR_PARAM;
    }

    if ((sec_info->write_addr + ((uint32_t)sizeof(eeprom_record_head_t) + (((uint32_t)(len) + 7) & ~7))) > (sec_info->active_page_addr + ((uint32_t)((uint32_t)0x0400U) * 1)))
    {
        for (page_index = ((sec_info->active_page_addr - sec_info->start_addr) / ((uint32_t)((uint32_t)0x0400U) * 1)) + 1;
             ...
             page_index++)
        {
            ...
            page_addr = sec_info->start_addr + (page_index * ((uint32_t)((uint32_t)0x0400U) * 1));
            flash_read_buf(page_addr, (uint8_t *)&page_flg, sizeof(page_flg));

            if (page_flg == 0xFFFFFFFF)
            {
                ...
                sec_info->active_page_addr = page_addr;
                sec_info->write_addr = page_addr + 8;
                break;
            }
        }
...
uint8_t ee_load(eeprom_sec_t sec, void *data, uint16_t len)
{
    ...
    for (page_index = 0; page_index < sec_info->page_count; page_index++)
    {
        ...
        while ((addr + sizeof(record_head)) <= (page_addr + ((uint32_t)((uint32_t)0x0400U) * 1)))
        {
            ...
            if ((record_head.record_flg != 0x55AA33CC) ||
                (record_head.len == 0) ||
                (((uint32_t)sizeof(eeprom_record_head_t) + (((uint32_t)(record_head.len) + 7) & ~7)) > (((uint32_t)((uint32_t)0x0400U) * 1) - 8)) ||
                ((addr + ((uint32_t)sizeof(eeprom_record_head_t) + (((uint32_t)(record_head.len) + 7) & ~7))) > (page_addr + ((uint32_t)((uint32_t)0x0400U) * 1))))
            {
                break;
            }
            ...
            addr += ((uint32_t)sizeof(eeprom_record_head_t) + (((uint32_t)(record_head.len) + 7) & ~7));
        }
    }
