...
void bsp_init(void);
# 2 "../Driver/ota_boot.c" 2
# 1 "../Driver/ota_boot.h" 1
# 16 "../Driver/ota_boot.h"
...
uint8_t is_app_valid(uint32_t app_addr)
{
    ...
    if ((app_stack < (0x10000000UL)) || (app_stack > ((0x10000000UL) + ((0x0400UL) * 96UL))) || ((app_stack & 0x3U) != 0U))
    {
        return 0;
    }
...
__attribute__((noreturn)) void jump_to_app(uint32_t app_addr)
{
    ...
    uint32_t jump_address = get_jumpaddress(app_addr);
...
uint8_t ota_app_verify(void)
{
    ...
    flash_read_buf((((((((0x00000000UL) + ((0x0400UL) * 12UL)) + ((0x0400UL) * 98UL)) + ((0x0400UL) * 98UL)) + ((0x0400UL) * 1UL) * 42) + ((0x0400UL) * 1UL) * 2) + ((0x0400UL) * 1UL) * 2), (uint8_t*)&ota_info, sizeof(ota_info));
    ...
    if (ota_info.iap_flg != 0x56AB56AB)
    {
        return 1;
    }

    if ((ota_info.fw_len == 0) || (ota_info.fw_len > ((0x0400UL) * 98UL)))
    {
        return 1;
    }
    ...
    md5_flash((((0x00000000UL) + ((0x0400UL) * 12UL)) + ((0x0400UL) * 98UL)), ota_info.fw_len, md5_result);
...
void ota_info_clear(void)
{
    flash_erase_page((((((((0x00000000UL) + ((0x0400UL) * 12UL)) + ((0x0400UL) * 98UL)) + ((0x0400UL) * 98UL)) + ((0x0400UL) * 1UL) * 42) + ((0x0400UL) * 1UL) * 2) + ((0x0400UL) * 1UL) * 2));
...
void ota_app_update(void)
{
    ...
    uint32_t addr_read = (((0x00000000UL) + ((0x0400UL) * 12UL)) + ((0x0400UL) * 98UL));
    uint32_t addr_write = ((0x00000000UL) + ((0x0400UL) * 12UL));


    flash_erase_range(((0x00000000UL) + ((0x0400UL) * 12UL)), ((0x00000000UL) + ((0x0400UL) * 12UL)) + ((0x0400UL) * 98UL));
